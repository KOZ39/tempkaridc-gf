...
function loadTable(){
    ...
    for(var i in objectList){
        ...
        var tde = '</td>';
        var item = '<tr id="table-row-' + i + '" idx="' + i + '" onClick="click_table_main(this)"; style="height:2em;">';
...
function resizeBoxes(){
    ...
    if(myWidth < 768){
        ...
        document.getElementById('tbl_mid').style.height = '240px';
